...
当前正式版是 [FQGate v1.0.4](https://github.com/fqgate/FQGate-releases/releases/tag/fqgate-v1.0.4)。

- Windows 电脑下载 `FQGate-1.0.4-windows-x64-UNSIGNED.zip`，解压后运行 `FQGate.exe`；也可以直接下载单文件 EXE。
- Apple 芯片 Mac 下载 `FQGate-1.0.4-macos-arm64-ADHOC.zip`。
- Intel 芯片 Mac 下载 `FQGate-1.0.4-macos-x86_64-ADHOC.zip`。
